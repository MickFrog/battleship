...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"default\": () => (/* binding */ initializePlayingBoards)\n/* harmony export */ });\n/* harmony import */ var _domUtil__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./domUtil */ \"./src/domBusiness/domUtil.js\");\n/* harmony import */ var _gameUtil__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../gameUtil */ \"./src/gameUtil.js\");\n/* harmony import */ var _gameHandler__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../gameHandler */ \"./src/gameHandler.js\");\n\n\n\n\nfunction initializePlayingBoards() {\n    (0,_domUtil__WEBPACK_IMPORTED_MODULE_0__.drawPositions)(_domUtil__WEBPACK_IMPORTED_MODULE_0__.DOM_Elements.humanBoard);\n\n    (0,_domUtil__WEBPACK_IMPORTED_MODULE_0__.drawPositions)(_domUtil__WEBPACK_IMPORTED_MODULE_0__.DOM_Elements.compBoard, true);\n    (0,_domUtil__WEBPACK_IMPORTED_MODULE_0__.addBoardEvents)(_domUtil__WEBPACK_IMPORTED_MODULE_0__.DOM_Elements.compBoard, compBoardEvents);\n}\n\n//eventHandlers\n_domUtil__WEBPACK_IMPORTED_MODULE_0__.DOM_Elements.restartBtn.addEventListener('click', () => {\n    //reload page to restart game\n    location.reload();\n});\n\nfunction compBoardEvents(boxElem) {\n    boxElem.addEventListener('click', () => {\n        if (_gameHandler__WEBPACK_IMPORTED_MODULE_2__.players.activePlayer == _gameHandler__WEBPACK_IMPORTED_MODULE_2__.players.humanPlayer) { //if human is active player\n            let shotMade = _gameHandler__WEBPACK_IMPORTED_MODULE_2__.players.humanPlayer.castShot(_gameHandler__WEBPACK_IMPORTED_MODULE_2__.players.compPlayer, boxElem.id);\n            boxElem.classList.remove('hoverBox');\n    \n            handleShot(shotMade, boxElem);\n\n            _gameUtil__WEBPACK_IMPORTED_MODULE_1__[\"default\"].switchPlayer();\n        }\n        handleAIShot();\n        \n        let winner = _gameUtil__WEBPACK_IMPORTED_MODULE_1__[\"default\"].gameWon();\n        if (winner != null) {\n            evaluateWin(winner);\n        }\n    }); \n}\n\nfunction handleShot(shotResult, shotBox) {\n    if (shotResult === -1) return;\n\n    if (shotResult === 0) {\n        shotBox.classList.add('missedBox');\n        return;\n    }\n    //when shot made at ship\n    shotBox.classList.add('hitBox');\n}\n\nfunction handleAIShot() {\n    if (_gameHandler__WEBPACK_IMPORTED_MODULE_2__.players.activePlayer == _gameHandler__WEBPACK_IMPORTED_MODULE_2__.players.compPlayer) {\n        //cast AI player shot\n        let [shotMade, shotResult] = _gameHandler__WEBPACK_IMPORTED_MODULE_2__.players.compPlayer.castShot(_gameHandler__WEBPACK_IMPORTED_MODULE_2__.players.humanPlayer);\n    \n        //get box shot in html\n        let humanBoardChildren = [..._domUtil__WEBPACK_IMPORTED_MODULE_0__.DOM_Elements.humanBoard.children];\n        const boxShot = humanBoardChildren.find(elem => elem.id == shotMade);\n    \n        handleShot(shotResult, boxShot);\n    \n        _gameUtil__WEBPACK_IMPORTED_MODULE_1__[\"default\"].switchPlayer();\n    }\n}\n\nfunction evaluateWin(myWinner) {\n    _domUtil__WEBPACK_IMPORTED_MODULE_0__.DOM_Elements.overlay.style.display = 'flex';\n    _domUtil__WEBPACK_IMPORTED_MODULE_0__.DOM_Elements.winDiv.style.display = 'flex';\n    \n    if (myWinner == _gameHandler__WEBPACK_IMPORTED_MODULE_2__.players.humanPlayer) {\n        //display human win msg\n        _domUtil__WEBPACK_IMPORTED_MODULE_0__.DOM_Elements.winMsg.textContent = 'You Won! Congratulations';\n    }\n\n    if (myWinner == _gameHandler__WEBPACK_IMPORTED_MODULE_2__.players.compPlayer) {\n        //display computer win message\n        _domUtil__WEBPACK_IMPORTED_MODULE_0__.DOM_Elements.winMsg.textContent = 'You Lost!';\n    }\n}\n\n//# sourceURL=webpack://battleship/./src/domBusiness/gamePlaying.js?");
...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"default\": () => (__WEBPACK_DEFAULT_EXPORT__)\n/* harmony export */ });\n/* harmony import */ var _gameHandler__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./gameHandler */ \"./src/gameHandler.js\");\n\n\nconst gameUtil = {\n    switchPlayer: () => {\n        _gameHandler__WEBPACK_IMPORTED_MODULE_0__.players.activePlayer == _gameHandler__WEBPACK_IMPORTED_MODULE_0__.players.humanPlayer \n        ? _gameHandler__WEBPACK_IMPORTED_MODULE_0__.players.activePlayer = _gameHandler__WEBPACK_IMPORTED_MODULE_0__.players.compPlayer\n        : _gameHandler__WEBPACK_IMPORTED_MODULE_0__.players.activePlayer = _gameHandler__WEBPACK_IMPORTED_MODULE_0__.players.humanPlayer\n    },\n\n    gameWon: () => { //return winner of game\n        if (_gameHandler__WEBPACK_IMPORTED_MODULE_0__.players.humanPlayer.playerBoard.boardShips.length == 0) {\n            return _gameHandler__WEBPACK_IMPORTED_MODULE_0__.players.compPlayer;\n        }\n\n        if (_gameHandler__WEBPACK_IMPORTED_MODULE_0__.players.compPlayer.playerBoard.boardShips.length == 0) {\n            return _gameHandler__WEBPACK_IMPORTED_MODULE_0__.players.humanPlayer;\n        }\n        \n        return null;\n    },\n}\n\n/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (gameUtil);\n\n//# sourceURL=webpack://battleship/./src/gameUtil.js?");
